...
require_once("UserDAO.php"); 
    ...
    class SolicitacaoCompraDAO{
        ...
        public function ConsultarPoCompra($codPO){
            $consulta = $this->banco->prepare('SELECT 
                p.Titulo, p.id_identificador, p.status, p.Prioridade, p.id_mat, p.id_forn, p.preco_unit, p.preco_total, f.nomeFantasia, m.nomeMat, p.qtdMat, 
        ...
        public function Atualizar_PoCompra($id_identificador, $titulo, $id_forn, $materiais, $Prioridade, $Status) {
            ...
            try {
                ...
                $sql = "INSERT INTO pedidocompra (Titulo, id_forn, id_mat, qtdMat, preco_unit, preco_total, Prioridade, id_identificador, status) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                foreach ($materiais as $material) {
                    $inserir->execute([
                        ...
                        $material['preco_total'],    // Preço total
